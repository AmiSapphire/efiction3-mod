...
<input type='submit' class='button' name='submit' id='submit' value='"._SUBMIT."'>
	...
	$output .= "<form name='shoutopts' method='POST' id='settingsform' style=\"width: 38em;\" action='admin.php?action=blocks&amp;admin=shoutbox'>\n
<div><label style=\"margin-top: 0.5em;\" for='shoutdate'>"._SHOUTDATE.":</label><select name='shoutdate' id='shoutdate'><option value=\"\">"._SELECTONE."</option>";
...
<div><label style=\"margin-top: 0.06em;\" for='shoutlimit'>"._SHOUTLIMIT.":</label><input type='text' name='shoutlimit' size='1' value='".(isset($blocks['shoutbox']['shoutlimit']) ? $blocks['shoutbox']['shoutlimit'] : "")."'></div>
<div class='fieldset'><span style=\"width: 12em; margin-right: -0.8em;\" class='label'><label for='guestshouts'>"._GUESTSHOUTS.":</label></span>\n
...
<input type='submit' style=\"margin-left: 31.8%; margin-top: 0.3em;\"class='button' name='submitopts' id='submit' value='"._SUBMIT."'></form>";
